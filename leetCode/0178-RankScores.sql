...
Select * 
From Scores; -- Personal note: I would name this the singular Score... 
             -- ... although it would most likely have another table associated with the score like: UserScore, ExamScore, GameScore
